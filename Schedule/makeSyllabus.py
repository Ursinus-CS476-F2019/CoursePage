...
Ds = [datetime.timedelta(2), datetime.timedelta(5)] #Monday To Wednesday, Wednesday To Monday
Holidays = {datetime.date(2019, 10, 14):"Fall Break", datetime.date(2019, 11, 27):"Thanksgiving"}
